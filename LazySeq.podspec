...
Pod::Spec.new do |s|
  s.name             = 'LazySeq'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LazySeq.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Oleksii Horishnii/LazySeq'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Oleksii Horishnii' => 'oleksii.horishnii@gmail.com' }
  s.source           = { :git => 'https://github.com/Oleksii Horishnii/LazySeq.git', :tag => s.version.to_s }
